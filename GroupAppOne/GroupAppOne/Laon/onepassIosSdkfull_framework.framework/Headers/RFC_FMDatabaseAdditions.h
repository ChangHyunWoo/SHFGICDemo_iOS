...
#import "RFC_FMDatabase.h"


/** Category of additions for `<RFC_FMDatabase>` class.
...
@interface RFC_FMDatabase (RFC_FMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `RFC_FMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `RFC_FMResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (RFC_FMResultSet*)getSchema;
...
- (RFC_FMResultSet*)getTableSchema:(NSString*)tableName;

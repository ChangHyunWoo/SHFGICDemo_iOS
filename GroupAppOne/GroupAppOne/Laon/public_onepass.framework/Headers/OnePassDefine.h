...
//버전.
#define ONEPASS_VERSION @"1.0.23.6992"
...
typedef enum {
    ...
    ONEPASS_OPERATION_AUTHENTICATION_2,
    ...
    ONEPASS_OPERATION_CHECK_REGISTERED_STATUS
} ONEPASS_OPERATION;
...
#define ONEPASS_SERVICE_COMMAND_NAME_AUTHENTICATION_2 @"requestServiceAuth2"
...
#define ONEPASS_SERVICE_COMMAND_NAME_CHECK_REGISTERED_STATUS @"checkRegisteredStatus"
